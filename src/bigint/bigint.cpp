...
bigint::bigint(unsigned long int val) noexcept {
  mpz_init(&_z);
  mpz_set_ui(&_z, val);
}
...
bigint::bigint(long int val) noexcept {
  mpz_init(&_z);
  if (val >= 0)
    mpz_set_ui(&_z, static_cast<unsigned long int>(val));
  else {
    mpz_set_ui(&_z, static_cast<unsigned long int>(-val));
    mpz_neg(&_z, &_z);
  }
...
bigint::bigint(const std::string& str, int base) {
  ...
  for (size_t i = start; i < str.size(); i++) {
    ...
    if (c >= '0' && c <= '9')
      ...
      break;
    mpz_mul_ui(&_z, &_z, static_cast<unsigned long int>(base));
    mpz_add_ui(&_z, &_z, static_cast<unsigned long int>(digit));
  }
...
bigint bigint::factorial(unsigned long int n) {
  bigint result(1UL);
...
bigint bigint::factorial(bigint const& n) {
  ...
  bigint result(1UL);
  for (bigint i(2UL); i <= n; ++i) result *= i;
  return result;
}

bigint bigint::operator+(const bigint& rhs) const {
  bigint r;
  mpz_add(&r._z, &_z, &rhs._z);
  return r;
}
bigint bigint::operator-(const bigint& rhs) const {
  bigint r;
  mpz_sub(&r._z, &_z, &rhs._z);
  return r;
}
bigint bigint::operator*(const bigint& rhs) const {
  bigint r;
  mpz_mul(&r._z, &_z, &rhs._z);
  return r;
}
...
bigint bigint::operator/(const bigint& rhs) const {
  check_div(rhs);
  bigint r;
  mpz_tdiv_q(&r._z, &_z, &rhs._z);
  return r;
}
bigint bigint::operator%(const bigint& rhs) const {
  check_div(rhs);
  bigint r;
  mpz_tdiv_r(&r._z, &_z, &rhs._z);
  return r;
}

bigint& bigint::operator+=(const bigint& rhs) {
  mpz_add(&_z, &_z, &rhs._z);
  return *this;
}
bigint& bigint::operator-=(const bigint& rhs) {
  mpz_sub(&_z, &_z, &rhs._z);
  return *this;
}
bigint& bigint::operator*=(const bigint& rhs) {
...
bigint& bigint::operator/=(const bigint& rhs) {
  check_div(rhs);
  mpz_tdiv_q(&_z, &_z, &rhs._z);
  return *this;
}
bigint& bigint::operator%=(const bigint& rhs) {
  check_div(rhs);
  mpz_tdiv_r(&_z, &_z, &rhs._z);
  return *this;
}
...
bigint bigint::operator&(const bigint& rhs) const {
  bigint r;
  mpz_and(&r._z, &_z, &rhs._z);
  return r;
}
bigint bigint::operator|(const bigint& rhs) const {
  bigint r;
  mpz_or(&r._z, &_z, &rhs._z);
  return r;
}
bigint bigint::operator^(const bigint& rhs) const {
  bigint r;
  mpz_xor(&r._z, &_z, &rhs._z);
  return r;
}
bigint bigint::operator~() const {
  bigint r;
...
bigint bigint::operator<<(unsigned long int shift) const {
  bigint r;
  mpz_mul_2exp(&r._z, &_z, shift);
  return r;
}
bigint bigint::operator>>(unsigned long int shift) const {
  bigint r;
  mpz_div_2exp(&r._z, &_z, shift);
  return r;
}

bigint& bigint::operator&=(const bigint& rhs) {
  mpz_and(&_z, &_z, &rhs._z);
  return *this;
}
bigint& bigint::operator|=(const bigint& rhs) {
  mpz_or(&_z, &_z, &rhs._z);
...
bigint& bigint::operator^=(const bigint& rhs) {
  mpz_xor(&_z, &_z, &rhs._z);
  return *this;
}
bigint& bigint::operator<<=(unsigned long int shift) {
  mpz_mul_2exp(&_z, &_z, shift);
  return *this;
}
bigint& bigint::operator>>=(unsigned long int shift) {
  mpz_div_2exp(&_z, &_z, shift);
  return *this;
}
...
bigint::operator int() const { return static_cast<int>(mpz_get_si(&_z)); }
...
bigint bigint::pow(unsigned long int exp) const {
  bigint r;
  mpz_pow_ui(&r._z, &_z, exp);
  return r;
}

bigint bigint::powm(const bigint& exp, const bigint& mod) const {
  bigint r;
  mpz_powm(&r._z, &_z, &exp._z, &mod._z);
  return r;
}

bool bigint::invert(bigint& rop, const bigint& mod) const { return mpz_invert(&rop._z, &_z, &mod._z) != 0; }
...
bigint bigint::lcm(const bigint& a, const bigint& b) {
  bigint r;
  mpz_lcm(&r._z, &a._z, &b._z);
  return r;
}

bigint bigint::tdiv_q(const bigint& d) const {
  check_div(d);
  bigint r;
  mpz_tdiv_q(&r._z, &_z, &d._z);
  return r;
}
bigint bigint::tdiv_r(const bigint& d) const {
  check_div(d);
  bigint r;
  mpz_tdiv_r(&r._z, &_z, &d._z);
  return r;
}
std::pair<bigint, bigint> bigint::tdiv_qr(const bigint& d) const {
  check_div(d);
  bigint q, r;
  mpz_tdiv_qr(&q._z, &r._z, &_z, &d._z);
  return {std::move(q), std::move(r)};
}

bigint bigint::fdiv_q(const bigint& d) const {
  check_div(d);
  bigint r;
  mpz_fdiv_q(&r._z, &_z, &d._z);
  return r;
}
bigint bigint::fdiv_r(const bigint& d) const {
  check_div(d);
  bigint r;
  mpz_fdiv_r(&r._z, &_z, &d._z);
  return r;
}
std::pair<bigint, bigint> bigint::fdiv_qr(const bigint& d) const {
  check_div(d);
  bigint q, r;
  mpz_fdiv_qr(&q._z, &r._z, &_z, &d._z);
  return {std::move(q), std::move(r)};
}

bigint bigint::cdiv_q(const bigint& d) const {
  check_div(d);
  bigint r;
  mpz_cdiv_q(&r._z, &_z, &d._z);
  return r;
}
bigint bigint::cdiv_r(const bigint& d) const {
  check_div(d);
  bigint r;
  mpz_cdiv_r(&r._z, &_z, &d._z);
  return r;
}
std::pair<bigint, bigint> bigint::cdiv_qr(const bigint& d) const {
  check_div(d);
  bigint q, r;
  mpz_cdiv_qr(&q._z, &r._z, &_z, &d._z);
  return {std::move(q), std::move(r)};
}

bigint bigint::tdiv_q_unsafe(const bigint& d) const {
  bigint r;
  mpz_tdiv_q(&r._z, &_z, &d._z);
  return r;
}
bigint bigint::tdiv_r_unsafe(const bigint& d) const {
  bigint r;
  mpz_tdiv_r(&r._z, &_z, &d._z);
  return r;
}
...
bigint bigint::fdiv_q_unsafe(const bigint& d) const {
  bigint r;
  mpz_fdiv_q(&r._z, &_z, &d._z);
  return r;
}
bigint bigint::fdiv_r_unsafe(const bigint& d) const {
  bigint r;
  mpz_fdiv_r(&r._z, &_z, &d._z);
  return r;
}
...
bigint bigint::cdiv_q_unsafe(const bigint& d) const {
  bigint r;
  mpz_cdiv_q(&r._z, &_z, &d._z);
  return r;
}
bigint bigint::cdiv_r_unsafe(const bigint& d) const {
  bigint r;
  mpz_cdiv_r(&r._z, &_z, &d._z);
  return r;
}
...
bigint bigint::mod(const bigint& d) const {
  check_div(d);
  bigint r;
  mpz_mod(&r._z, &_z, &d._z);
  return r;
}
bigint bigint::mod_unsafe(const bigint& d) const {
  bigint r;
  mpz_mod(&r._z, &_z, &d._z);
  return r;
}
...
int bigint::scan1(unsigned long int start) const { return mpz_scan1(&_z, start); }
...
std::string bigint::to_string(int base) const {
  const unsigned long int sz = mpz_sizeinbase(&_z, base) + 2;
...
bigint bigint::operator+(unsigned long int rhs) const {
  bigint r;
  mpz_add_ui(&r._z, &_z, rhs);
  return r;
}
bigint bigint::operator-(unsigned long int rhs) const {
  bigint r;
  mpz_sub_ui(&r._z, &_z, rhs);
  return r;
}
bigint bigint::operator*(unsigned long int rhs) const {
  bigint r;
  mpz_mul_ui(&r._z, &_z, rhs);
  return r;
}

bigint& bigint::operator+=(unsigned long int rhs) {
  mpz_add_ui(&_z, &_z, rhs);
  return *this;
}
bigint& bigint::operator-=(unsigned long int rhs) {
  mpz_sub_ui(&_z, &_z, rhs);
  return *this;
}
bigint& bigint::operator*=(unsigned long int rhs) {
  mpz_mul_ui(&_z, &_z, rhs);
  return *this;
}