...
class bigfloat final {
 ...
 public:
  ...
  friend std::ostream &operator<<(std::ostream &out, bigfloat const &num) noexcept;
...
bigfloat sin(bigfloat const &number, bigfloat const &EPS = bigfloat::DEFAULT_EPS);
bigfloat cos(bigfloat const &number, bigfloat const &EPS = bigfloat::DEFAULT_EPS);
bigfloat tg(bigfloat const &number, bigfloat const &EPS = bigfloat::DEFAULT_EPS);
bigfloat ctg(bigfloat const &number, bigfloat const &EPS = bigfloat::DEFAULT_EPS);
bigfloat sec(bigfloat const &number, bigfloat const &EPS = bigfloat::DEFAULT_EPS);
bigfloat cosec(bigfloat const &number, bigfloat const &EPS = bigfloat::DEFAULT_EPS);
bigfloat arcsin(bigfloat const &number, bigfloat const &EPS = bigfloat::DEFAULT_EPS);
bigfloat arccos(bigfloat const &number, bigfloat const &EPS = bigfloat::DEFAULT_EPS);
bigfloat arctg(bigfloat const &number, bigfloat const &EPS = bigfloat::DEFAULT_EPS);
bigfloat arcctg(bigfloat const &number, bigfloat const &EPS = bigfloat::DEFAULT_EPS);
bigfloat arcsec(bigfloat const &number, bigfloat const &EPS = bigfloat::DEFAULT_EPS);
bigfloat arccosec(bigfloat const &number, bigfloat const &EPS = bigfloat::DEFAULT_EPS);

bigfloat radical(bigfloat const &radicand, bigint const &index, bigfloat const &EPS = bigfloat::DEFAULT_EPS);
bigfloat sqrt(bigfloat const &radicand, bigfloat const &EPS = bigfloat::DEFAULT_EPS);

bigfloat log2(bigfloat const &number, bigfloat const &EPS = bigfloat::DEFAULT_EPS);
bigfloat log(bigfloat const &number, bigfloat const &EPS = bigfloat::DEFAULT_EPS);
bigfloat log10(bigfloat const &number, bigfloat const &EPS = bigfloat::DEFAULT_EPS);
