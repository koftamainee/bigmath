...
void mpz_init_multiple(int count, ...) BIGMATH_NOTHROW;

void mpz_set_ui_multiple(int count, ...) BIGMATH_NOTHROW;

void mpz_set_multiple(int count, ...) BIGMATH_NOTHROW;

void mpz_init_set_ui_multiple(int count, ...) BIGMATH_NOTHROW;

void mpz_init_set_multiple(int count, ...) BIGMATH_NOTHROW;
